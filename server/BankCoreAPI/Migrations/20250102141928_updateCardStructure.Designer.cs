...
namespace BankCoreAPI.Migrations
{
    ...
    [Migration("20250102141928_updateCardStructure")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankCoreAPI.Core.Models.Accounts.AccountTransaction", b =>
                {
                    b.HasOne("BankCoreAPI.Core.Models.Accounts.Account", "AccountFrom")
                        .WithMany("AccountFromTransactions")
                        .HasForeignKey("AccountFromId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BankCoreAPI.Core.Models.Accounts.Account", "AccountTo")
                        .WithMany("AccountToTransactions")
            ...
            modelBuilder.Entity("BankCoreAPI.Core.Models.Cards.CardTransaction", b =>
                {
                    b.HasOne("BankCoreAPI.Core.Models.Cards.Card", "CardFrom")
                        .WithMany("CardFromTransactions")
                        .HasForeignKey("CardFromId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BankCoreAPI.Core.Models.Cards.Card", "CardTo")
                        .WithMany("CardToTransactions")
            ...
            modelBuilder.Entity("BankCoreAPI.Core.Models.Accounts.Account", b =>
                {
                    b.Navigation("AccountFromTransactions");

                    b.Navigation("AccountToTransactions");
                });
            ...
            modelBuilder.Entity("BankCoreAPI.Core.Models.Cards.Card", b =>
                {
                    b.Navigation("CardFromTransactions");

                    b.Navigation("CardToTransactions");
                });
